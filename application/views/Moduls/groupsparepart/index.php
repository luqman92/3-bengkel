                ...
                <section class="content-header">
                    <h1>
                        Group Sparepart Motor
                        <small>List Sparepart Motor</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url(); ?>index.php/admin"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">List Sparepart Motor</li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="listkat" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                        $no = 1;
                                        foreach ($gspareparts as $gsparepart) {
                                        ?>
                                            <tr>
                                                <td><?=$no;?></td>
                                                <td><?=$gsparepart->kode?></td>
                                                <td><?=$gsparepart->deskripsi?></td>
                                                <td><?=$gsparepart->margin?></td>
