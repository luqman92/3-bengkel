                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <button class="btn btn-success" onclick="add_user()"><i class="glyphicon glyphicon-plus"></i> Data User</button>
                                <br><br>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/ajax_list_user')?>",
            "type": "POST"
        },
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="pass" placeholder="" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="notelp" placeholder="" class="form-control" type="number">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="level">
                                    ...
                                    <?php 
                                        foreach ($user_level as $ruser_level) {
                                            echo "<option value=".$ruser_level->idlevel.">".$ruser_level->title."</option>";
                                        }
                                    ?>
                                </select>
                                <span class="help-block"></span>
